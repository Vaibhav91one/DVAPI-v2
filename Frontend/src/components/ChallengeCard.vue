<template>
    <v-card class="mx-auto" max-width="500" style="border-radius: 5px;">
        <v-img :src=imageURL height="300px" cover></v-img>
            ...
            <v-btn variant="text" style="background-color: black; color: white; padding: 10px; margin: 10px;">
                <v-row justify="center">
                    <v-dialog v-model="dialog" width="540">
                        ...
                        <v-card>
                            <v-card-title style="justify-content: center; display: flex; margin-top: 20px; padding: 10px;">
                            ...
                            <v-card-actions style="margin: 10px; padding: 10px;">
                                ...
                                <v-spacer></v-spacer>
                                <v-btn color="white" variant="text" @click="dialog = false" style="background-color: black;">
                                    Submit
                                </v-btn>
                                <v-spacer></v-spacer>
                                <v-btn color="red">
...
<script>
export default {
    props: ['title', 'description', 'Level', 'imageURL'],
    data: () => ({
        show: false,
        dialog: false,
        dialogHint: false,
